 ...
 * adding a new theme is just "call UiTheme.register(...) with a new UiPalette
 * instance" - no switch statement to edit, see {@link UiTheme}.
 *
...
public record UiPalette(
	...
	/** The default dark palette, also a reasonable starting point to copy when building a custom theme. */
